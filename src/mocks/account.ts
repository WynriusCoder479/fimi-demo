...
export const accountCampaign = [
	{
		id: uid(),
		campaignName: 'mở tài khoản chứng khoán',
		productCode: 'yuanta',
		publisher: 'Công Ty Trách Nhiệm Hữu Hạn Chứng Khoán Yuanta Việt Nam',
		category: 'account',
		...
		image: 'https://w.ladicdn.com/60e5a6ef577a1e001299e3ac/logo-fimipsd-20240515063528-wiser.svg',
		createdAt: new Date(),
		cvr: '2.76%'
	}
] satisfies Info[]
